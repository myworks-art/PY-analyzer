...
export default function ResultPage() {
  ...
  useEffect(() => {
    getResult(id).then(setResult).catch(e => setError(e.message)).finally(() => setLoad(false))
  }, [id])

  if (loading) return <div className="main"><div className="empty"><div className="spinner" style={{ margin: '0 auto' }} /></div></div>
    ...
    <div className="main">
      <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:'2rem', flexWrap:'wrap', gap:'1rem' }}>
        <div>
          ...
          <div className="ph-title" style={{ marginBottom: '.25rem' }}>{result.filename}</div>
